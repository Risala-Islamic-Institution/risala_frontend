            ...
            >
                ...
                <div className="relative mt-auto max-w-lg">
                    ...
                    <p className="mt-6 font-display text-2xl leading-snug tracking-tight text-secondary-foreground/95 xl:text-[28px]">
                        &ldquo;Whoever travels a path in search of knowledge, Allah eases for him a path to Paradise.&rdquo;
                    </p>
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`relative flex flex-col gap-1 rounded-md border px-3.5 py-3 text-left transition-colors ${
                                                    active
                                                        ? 'border-primary bg-[color:var(--primary)]/[0.06]'
                                                        : 'border-border bg-card hover:border-foreground/30'
                                                }`}
                                            >
                                                <div className="flex items-center gap-2">
                                                    {opt.v === 'STUDENT' ? (
                                                        <GraduationCap className={`h-4 w-4 ${active ? 'text-primary' : 'text-muted-foreground'}`} />
                                                    ) : (
                                                        <Verified className={`h-4 w-4 ${active ? 'text-primary' : 'text-muted-foreground'}`} />
                                                    )}
